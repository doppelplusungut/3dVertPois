    ...
    for fold, (train_idx, val_idx) in enumerate(kf.split(train_subjects)):
        ...
        if save_predictions:
            ...
            create_self_training_pois(
                data_module_save_path = os.path.join(data_module_config_path, 'data_module_params.json'),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--poi-file-ending', type=str, help='Ending of the poi file to save predictions to')
    ...
    if args.config:
        with open(args.config, 'r') as f:
            ...
            run_cv(args.n_folds, experiment_config, save_predictions=args.save_predictions, poi_file_ending=args.poi_file_ending)
